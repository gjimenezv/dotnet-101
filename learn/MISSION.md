# Mission: Prep técnica para entrevista Sr. Software Engineer Full Stack (GFT, Costa Rica)

## Why
Tengo prueba práctica el domingo 2026-08-02 y entrevista técnica el lunes 2026-08-03 al mediodía, para el puesto [Sr. Software Engineer Full Stack en GFT](https://jobs.gft.com/Costarica/job/Heredia-Sr_-Software-Engineer_FullStack-40101/1416922633/). Ya domino React/JS/TypeScript, pero el puesto pide fuerte backend en C#/.NET + SQL Server/T-SQL + Entity Framework, stack en el que tengo práctica casi nula. Necesito pasar de "casi nulo" a "puedo hablar de esto con propiedad y escribir código básico correcto" en ~2 días de estudio real.
...
- Nivel de partida: casi nulo en C#/.NET/SQL Server. Viene de un background sólido en JS/TypeScript/React — usar esa base para tender puentes conceptuales (tipado, async, POO vs. funcional, etc.) en vez de enseñar desde cero absoluto.
- Prioridad: **cobertura amplia y funcional por encima de profundidad.** Preferir quick wins reconocibles en una prueba práctica/entrevista sobre dominio exhaustivo de cada tema.
- Sesiones deben ser rápidas de consumir — el tiempo es el recurso más escaso ahora mismo.
